...
(numvol varchar(6)      not null,
 ...
 constraint fk1_vol foreign key (numpilote)
	references pilote(numpilote),
 constraint fk2_vol foreign key (numavion)
...
--   Index : VOL_FK1                                           
-- ============================================================
create index VOL_FK1 on VOL (NUMAVION asc);
GO

-- ============================================================
--   Index : VOL_FK2                                           
-- ============================================================
create index VOL_FK2 on VOL (NUMPILOTE asc);
GO

-- *** occurences de pilote ***

insert into pilote values
     (1,'Ader Cl‚ment        ','Paris');
insert into pilote values
     (2,'Chanute             ','Nice');
insert into pilote values
     (3,'Lilienthal          ','Mulhouse');
insert into pilote values
     (4,'Bl‚riot Louis       ','Paris');
insert into pilote values
...
insert into pilote values
     (13,'Saint Exup‚ry       ','Marseille');
insert into pilote values
     (14,'Boucher H‚lŠne      ','Paris');
insert into pilote values
...
insert into avion values
     (16,'Boeing 717          ',360,'Montr‚al');
insert into avion values
     (17,'Boeing 747          ',460,'Montr‚al');
insert into avion values
